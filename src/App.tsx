...
class App extends Component {
	...
	handlePress = (event: NativeSyntheticEvent<NativeTouchEvent>) => {
		...
		this.idTextFunctionTagged.current?.doSomething();
	}
	...
	render() {
		return (
			<View style={styles.app}>
				...
				<Button onPress={this.handlePress} title="Example button" />
				<TitleTextClassTagged
					title="Class Component"
					ref={this.idTextClassTagged}
				/>
				<TitleTextFunctionTagged
					title="Function Component"
					ref={this.idTextFunctionTagged}
				/>
				<TitleTextFunctionWithoutRefTagged
					title="Function Component Without Ref"
				/>
			</View>
		);
	}
...
const styles = StyleSheet.create({
	...
	title: {
		fontWeight: "bold",
		fontSize: "1.5rem" as any as number,
		marginVertical: "1em",
		textAlign: "center"
	},
	text: {
		lineHeight: "1.5em" as any as number,
		fontSize: "1.125rem" as any as number,
		marginVertical: "1em",
		textAlign: "center"
	},
	link: {
